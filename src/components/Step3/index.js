  ...
  render() {
    ...
    <div className="container mt-4 ">
        <Card text="center">
            ...
            <hr/>
            <Card.Text>
               Now its time to start using the web services for your project. First were going to add a very advance Authenication to your project by using AWS-Cognito.
                <br/>
                <hr/>
                <h3 success>From your project's root folder in terminal run : amplify add auth</h3>
                <hr/>
                ...
                <hr/>
                 Do you want to use the default authentication and security configuration?  (defualt configuration)
                <hr/>
                ...
                <hr/>
                <h3 success>From your projects root folder in terminal run : amplify push</h3>
                ...
                <hr/>
                Now look in your aws-exports after the push is complete and see the new set of data added. Again never alter this manually is can damage the algorythem and not be repaired with out exstinsive migrains.
                <hr/>
